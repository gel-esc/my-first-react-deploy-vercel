        ...
        <>
            <Layout>
                <div className='w-full max-w-screen-lg'>
                    <button className='flex flex-grow items-center font-bold' onClick={onNavigateBack}>
                    ...
                    <div className='flex flex-column w-full mb-10 mt-10'>
                        ...
                        <div className='w-3/6 px-8'>
                            ...
                            <p className='font-bold mt-4 flex flex-row justify-end'>Price: <span className='text-red-800 text-2xl ml-4'>P{context.showProductDetail.price}</span></p>
                        ...
                        <div className='w-1/6'>
                            <span className='text-red-800 text-2xl'>P{context.showProductDetail.price}</span>
                            <p>Free shipping!</p>
